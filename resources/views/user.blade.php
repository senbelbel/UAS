    ...
    <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="card mt-4">
                        ...
                        <a name="" id="" class="btn btn-primary" href="/user/tambah" role="button">
                            ...
                            <table class="table table-hover">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>{{$u -> email}}</td>
                                        <td>
                                            <a href="/user/edituser/{{$u -> id}}" type= "button" class="btn btn-outline-primary"><i class="bi bi-pencil-square"></i></a>
                                            <a href="/user/hapususer/{{$u -> id}}" class="btn btn-outline-primary"><i class="bi bi-trash3"></i></a>
                                        </td>
                                    </tr>
                                    @endforeach
                                </tbody>
